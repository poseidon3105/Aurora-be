...
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'user@example.com', description: 'Registration email' }),
    (0, class_validator_1.IsEmail)({}, { message: 'Invalid email format' }),
    (0, class_validator_1.IsNotEmpty)(),
    __metadata("design:type", String)
], RegisterDto.prototype, "email", void 0);
__decorate([
    (0, swagger_1.ApiProperty)({ example: 'Abc@1234', description: 'Password (min 8 chars, 1 uppercase, 1 special char)' }),
